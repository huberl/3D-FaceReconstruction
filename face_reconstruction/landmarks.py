...
def detect_landmarks(img, return_face_pos=False):
    """
    Finds 68 landmarks on the given image.

    Parameters
    ----------
        img:
            the image in which landmarks should be found
        return_face_pos:
            whether the bounding box of the face should be returned as well

    Returns
    -------
        (68, 2) list of pixel coordinates that correspond to the found landmarks
        (optional) a bounding box of the found face
    """
